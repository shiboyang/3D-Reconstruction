...
class Frontend {
   ...
   private:
    ...
    /**
     * Try init the frontend with two images saved in current_frame_
     * @return true if success
     */
    bool Init();
    ...
    int MatchFeatures(const cv::Mat& descriptors1, 
    ...
    // utilities
    cv::Ptr<cv::SIFT> sift_detector;  // feature detector in opencv
    std::vector<cv::DMatch> matches;
